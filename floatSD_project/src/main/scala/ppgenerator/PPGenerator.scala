...
class PPGenerator(val grpnum: Int) extends Module {
  ...
  pp1_tmp := Mux(io.in.weight.grps(1)(1,0) === 3.U(2.W), 0.U, Cat(1.U, io.in.input.mantissa) << io.in.weight.grps(1)(1,0) << 3)
  pp2_tmp := Mux(io.in.weight.grps(0)(1,0) === 3.U(2.W), 0.U, Cat(1.U, io.in.input.mantissa) << io.in.weight.grps(0)(1,0))
